...
public class ShapeManager_HP : MonoBehaviour 
{
...
#region properties
	...
	public GameObject punchSheetParent;
...
#region methods
	...
	void CreateSheetToPunch() 
	{
		GameObject newItem  = null;
		
		newItem = Instantiate(shapePrefab, startPosition, Quaternion.identity);
		newItem.transform.parent = punchSheetParent.transform;
	}
}
